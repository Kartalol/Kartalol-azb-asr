...
def evaluation(base_path, model_dir):
    output_path = os.path.join(base_path, "kartalol_gold_testset/results_meduim_10ep_0827.csv")
...
if __name__ == "__main__":
    ...
    model_dir = os.path.join(base_path, "model/whisper-azb-finetuned-20250808/") # directory where your model is saved
